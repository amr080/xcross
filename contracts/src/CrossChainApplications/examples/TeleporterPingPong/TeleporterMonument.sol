...
/**
 * @dev TeleporterMonument is an example contract that demonstrates how to send and receive
 * messages cross chain.
 */
contract TeleporterMonument is ReentrancyGuard {
    ...
    function receiveTeleporterMessage(
        ...
        require(_messages[sourceBlockchainID].sender == address(0), "Message already received");
        // Store the message.
