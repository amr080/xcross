...
/**
 * @dev TeleporterPong is an example contract that demonstrates how to send and receive
 * messages cross chain.
 */
contract TeleporterPong is ReentrancyGuard {
     ...
     * Replies to the sending chain and address with a response.
     */
    function receiveTeleporterMessage(
        ...
        // Store the message.
        (string memory messageString, string memory responseString) = abi.decode(message, (string, string));
        ...
        teleporter.sendCrossChainMessage(
            TeleporterMessageInput({
                ...
                message: abi.encode(responseString)
            })
        );
    }
}
